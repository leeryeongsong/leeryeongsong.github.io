...
<br>
**주석 처리한 아래쪽 소스 코드**는  
**set 자료형 대신 list 자료형을 사용**한 코드이다.  
...
<br>
**x가 한수인지 판별하는 함수를 정의하자.**  
정의할 함수의 이름은 is_it_hansu이다.  
...
```
<br>
**지금까지 x가 한수인지 판별하는 함수를 정의했다.**  
<br>
<br>
**N을 입력받고 N 이하의 한수를 구하자.**  
...
<br>
<br>
이 문제의 알고리즘 분류에 "**브루트포스 알고리즘**" 항목이 있다.  
